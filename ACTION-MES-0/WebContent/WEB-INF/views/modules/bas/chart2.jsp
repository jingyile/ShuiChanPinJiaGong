...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/bas/workTime/chart2">员工年工作时长统计</a></li>
...
<!-- 2.查询 -->
<form:form id="searchForm" method="post" action="${ctx}/bas/workTime/chart2" modelAttribute="workTime" class="breadcrumb form-search">
    <div class="controls">
        <label>员工姓名：</label>
    ...
    <script type="text/javascript">
        $(function(){
            var xData=[];
            var yData=[];
            <c:forEach items="${eyearList}" var="workTime">
            xData.push("${workTime.year}${workTime.employeeName}");
