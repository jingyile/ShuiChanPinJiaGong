...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/bas/workTime/chart2cell">工位年工作时长统计</a></li>
</ul><br/>

<!-- 2.查询 -->
<form:form id="searchForm" method="post" action="${ctx}/bas/workTime/chart2cell" modelAttribute="workTime" class="breadcrumb form-search">
    <div class="controls">
        <label>工位名称：</label>
    ...
    <script type="text/javascript">
        $(function(){
            var xData=[];
            var yData=[];
            <c:forEach items="${ecellyList}" var="workTime">
            xData.push("${workTime.year}${workTime.cellName}");
