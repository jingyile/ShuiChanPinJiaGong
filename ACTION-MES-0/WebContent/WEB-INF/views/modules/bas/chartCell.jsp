...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/bas/workTime/chart0cell">工位周工作时长统计</a></li>
    <li><a href="${ctx}/bas/workTime/chart1cell">工位月工作时长统计</a></li>
    <li><a href="${ctx}/bas/workTime/chart2cell">工位年工作时长统计</a></li>
</ul><br/>

<!-- 2.查询 -->
<form:form id="searchForm" method="post" action="${ctx}/bas/workTime/chart0cell" modelAttribute="workTime" class="breadcrumb form-search">
    <div class="controls">
        <label>工位名称：</label>
    ...
    <script type="text/javascript">
        $(function(){
            var xData=[];
            var yData=[];
            <c:forEach items="${ecellwList}" var="workTime">
            xData.push("${workTime.week}${workTime.cellName}");
