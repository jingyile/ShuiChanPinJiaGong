...
<body>
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="${ctx}/tec/flowProcess/">工序路由与工序关系</a></li>
            <li><a href="${ctx}/tec/flowProcess/form">工序路由与工序关系添加</a></li>
        </ul>
        <%--2.查询--%>
            ...
            <c:forEach items="${page.list}" var="flowProcess">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="${ctx}/tec/flowProcess/delete?id=${flowProcess.id}" onclick="return confirmx('确认要删除该工艺流程与工序的关系信息吗？',this.href)">删除</a>
                    </td>
