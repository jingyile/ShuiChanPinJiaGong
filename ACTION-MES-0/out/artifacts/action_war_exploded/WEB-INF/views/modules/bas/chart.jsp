...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/bas/workTime/">员工周工作时长统计</a></li>
...
<!-- 2.查询 -->
<form:form id="searchForm" method="post" action="${ctx}/bas/workTime" modelAttribute="workTime" class="breadcrumb form-search">
    <div class="controls">
        <label>员工姓名：</label>
...
<%--        <form:input path="year" maxlength="50" class="input-medium wdate" htmlEscape="false" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"/>--%>
    ...
    <script type="text/javascript">
        $(function(){
            var xData=[];
            var yData=[];
            <c:forEach items="${eweekList}" var="workTime">
            xData.push("${workTime.week}${workTime.employeeName}");
