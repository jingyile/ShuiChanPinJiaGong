...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/equip/report">设备保修列表</a></li>
</ul>
<br/>

<!-- 查询-->
<form:form id="searchForm" method="post" action="${ctx}/equip/report/list" modelAttribute="equipFaultReport" class="breadcrumb form-search">
